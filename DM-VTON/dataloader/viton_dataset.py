...
class LoadVITONDataset(Dataset):
    def __init__(
        ...
        # self.img_names.append("cropped_captured_image_84-removebg-preview.png")
        # self.img_names.append(f"cropped_0130_{opt.counter}.jpg")
        self.img_names.append(f"{frame}")
        self.cloth_names.append("018138_1.jpg")
